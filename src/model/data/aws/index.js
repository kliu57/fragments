// Implements fragment database related calls using the In-Memory Database backend.
...
async function deleteFragment(ownerId, id) {
  ...
  try {
    logger.debug({ params }, 'Trying to delete metadata from DynamoDB');
    return ddbDocClient.send(command);
  } catch (err) {
...
// Deletes fragment's data from an S3 Object in a Bucket
